...
;
; Description:
;   Returns the version of the FO4StringUtils plugin.
;
; Parameters:
;   None.
;
; Returns:
;   A string representing the plugin version (e.g. "1.0").
;
; Notes:
;   This function can be used by mods to verify that FO4StringUtils
;   is installed and to perform version checks if needed.
;---------------------------------------------------------------------------
String   Function PluginVersion() Global Native

;---------------------------------------------------------------------------
; Function: GameVersion
;
; Description:
;   Returns the game version this plugin was built against.
;
; Parameters:
;   None.
;
; Returns:
;   A string representing the game version
;   (e.g. "1.10.163").
;
; Notes:
;   Provided for diagnostic, compatibility, and debugging purposes.
;   This value is informational and does not imply runtime enforcement.
;---------------------------------------------------------------------------
String   Function GameVersion() Global Native

;---------------------------------------------------------------------------
; Function: RuntimeVersion
;
; Description:
;   Returns the script extender runtime version used to build this plugin.
;
; Parameters:
;   None.
;
; Returns:
;   A string representing the script extender runtime version
;   (e.g. "0.6.23").
;
; Notes:
;   Useful for debugging, logging, and ensuring expected runtime behavior.
;---------------------------------------------------------------------------
String   Function RuntimeVersion() Global Native

;---------------------------------------------------------------------------
; Function: VersionInfo
;
; Description:
;   Returns a combined version string containing plugin, game,
;   and script extender runtime version information.
;
; Parameters:
;   None.
;
; Returns:
;   A formatted version string in the following form:
;     "Plugin:<plugin>,Game:<game>,Runtime:<runtime>"
;
;   Example:
;     "Plugin:1.0,Game:1.10.163,Runtime:0.6.23"
;
; Notes:
;   Intended for logging, diagnostics, and compatibility checks.
;   This provides a simple, single-call way to retrieve all
;   relevant version information.
;---------------------------------------------------------------------------
String   Function VersionInfo() Global Native
